...
# 2. Request for Comments (RFC)
 ...
 > Yeh official documents hotay hain jin mein internet ke tamam new protocols, standard proposals, aur technologies ki complete documentation aur rules record hotay hain.

## Key Point: IETF in RFC documents ko publish aur maintain karta hai (maslan HTTP, TCP, IPv4 wagera sab ke specific RFC numbers hotay hain).
...
Standards Organizations rules aur standards design karti hain, aur wo rules RFC documents ki soorat mein formally publish hote hain.
