...
* **Bit:**
 ...
 > The smallest unit of data in computing, represented as either a `0` or `1`.

* **Octet:**

  >  A group of 8 consecutive bits (equivalent to 1 Byte) in networking terminology.

* **Dotted-Decimal Notation:**

  > The standard human-readable format for writing IPv4 addresses, separating four decimal numbers with periods.

* **Packet Tracer:**

  > Cisco’s network simulation tool used to observe and test network behavior, data flow, and device configurations.
